...
public final class AdiClubMember {
  private final AdiClubMemberUserEmail email;
  ...
  public AdiClubMember(
      final AdiClubMemberUserEmail email,
  ...
  public AdiClubMemberUserEmail email() {
    return email;
  }

  public AdiClubMemberRegistrationDate registrationDate() {
    return registrationDate;
  }

  public AdiClubMemberMembershipPoints membershipPoints() {
